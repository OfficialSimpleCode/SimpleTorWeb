...
WQ(d,e,f,g){var x=0,w=A.j(y.b),v,u,t,s,r
var $async$WQ=A.e(function(h,i){if(h===1)return A.f(i,w)
while(true)switch(x){case 0:x=2
return A.c(A.bK(e,A.ai("statistcsPage",0)),$async$WQ)
case 2:u=i
t=$.bq().a
s=y.g
r=A.cV(t.a,s)
...
s=A.fg(new B.cQO(f,d),null,y.b)
x=6
return A.c(A.Q(e,!1).ed(s),$async$WQ)
...
F=c[405]
var z=a.updateTypes(["L3(B)","Hn(B)"])
B.cQO.prototype={
$1(d){A.ae("statistcsPage")
return D.dC8(this.b,this.a)},
$S:z+0}
B.cPO.prototype={
$1(d){A.ae("customersPage")
return E.dsM(this.b,this.a)},
...
((a,b)=>{a[b]=a.current
a.eventLog.push({p:"main.dart.js_307",e:"endPart",h:b})})($__dart_deferred_initializers__,"J/EGnnHBLsRdxio5Wf6XB+ksxf0=");