...
bG8(d){var x,w,v,u,t=this,s=d.id
...
this.k1.i(0,w,e)},
bGc(d){var x,w,v,u,t=this,s=t.ahp(d.ok)
if(s===-1)return
x=t.cx
...
bGg(d,e){var x,w=A.a7(0,1,1,0,0,0,0,!1)
...
v=w.c
u=d.ok
if(!u.ae(v.b)&&!u.ai(v.c))if(d.id!=null){w.bG8(d)
w.bGe(d.id,d.ok)
w.bGf(d.id,d.y1)}else{v=d.RG
