...
w.a=null
x=A.cK(null,0,!0)
$.b2.ac$.push(new B.bbY(w,x))
return new E.oq(new A.es(new B.bbZ(w,x),null),null)}}
var z=a.updateTypes([])
B.bbY.prototype={
...
t=u.h(0,"reminder")
t.toString
t=D.awv("alertToCustomersAboutComing","alertBookingTemplate",new B.bbV(x),new B.bbW(d),C.cq,!0,t,C.bl,"reminderShowcase")
u=u.h(0,"approvalArrivalReminder")
u.toString
return A.dK(v,s,A.hF(A.a([new A.m(s,24,s,s),w,t,D.awv("needConfirmationTitle","needConfirmBookingMessageFormat",new B.bbX(d),s,C.dl,!1,u,C.c7,"approvalArrivalReminderShowcase"),new A.m(s,30,s,s)],y.e),C.b3,s,x,!1),s,s,!1,s,s,23,!1,!1,x,!0)},
$S:102}
B.bbV.prototype={
